...
// «Для начинающих — 100 ₽ за час», цена выделена жирным. Читается как фраза.
//
...
/** «1 000 ₽ за час» → сумма отдельно, условие отдельно: жирной делаем
 *  только сумму, иначе при переносе «за час» повисает жирной строкой. */
...
const s = sheet(() => ({
  ...
  // Строка целиком: «Для начинающих — 100 ₽ за час». Плитки и рамки убраны —
