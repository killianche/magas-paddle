...
/** Когда игра — человеческим языком, для сообщений в Telegram. */
export const whenRu = (a: Date, b: Date) =>
  a.toLocaleDateString('ru-RU', { day: 'numeric', month: 'long', timeZone: 'Europe/Moscow' })
